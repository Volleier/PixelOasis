...
window.PO.CapabilityLabels = (function () {
  ...
  var CAPABILITIES_FIXTURE = [
    ...
    },
    {
      ...
      parameterSchema: { properties: { seed: { type: "integer", minimum: 0, maximum: 4294967295, default: -1, title: "随机种子", description: "-1 为随机" }, profile: { type: "string", enum: ["quality_16gb","balanced_16gb"], default: "quality_16gb", title: "质量档" }, density: { type: "number", minimum: 0.05, maximum: 1, default: 0.5, title: "浓度", description: "烟体不透明度与覆盖面积" }, direction: { type: "string", enum: ["upRight","upLeft","right","left","up","auto"], enumLabels: ["右上","左上","右","左","上","自动"], default: "upRight", title: "方向", description: "主气流方向" }, spread: { type: "number", minimum: 0.1, maximum: 1, default: 0.45, title: "扩散", description: "烟团扩散角度与面积" }, turbulence: { type: "number", minimum: 0, maximum: 1, default: 0.55, title: "湍流", description: "噪声卷曲程度" }, particleAmount: { type: "number", minimum: 0, maximum: 1, default: 0.35, title: "粉尘数量", description: "粉尘数量与亮度" }, occlusion: { type: "string", enum: ["auto","back","front"], enumLabels: ["自动","后景","前景"], default: "auto", title: "遮挡", description: "与主体的前后遮挡关系" }, semanticRefine: { type: "boolean", default: false, title: "语义精修", description: "局部 Qwen 融合精修" } } },
      availability: { state: "missing_nodes", profile: null },
