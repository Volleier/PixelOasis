...
window.PO.CapabilityLabels = (function () {
  ...
  var CAPABILITIES_FIXTURE = [
    /* ── 场景氛围 (4) ── */
    {
      ...
      parameterSchema: { properties: { seed: { type: "integer", default: -1, title: "随机种子", description: "-1 为随机" }, profile: { type: "string", enum: ["quality_16gb","balanced_16gb"], default: "quality_16gb", title: "质量档" }, intensity: { type: "number", minimum: 0, maximum: 1, default: 0.55, title: "强度", description: "风沙粒子浓度" }, wind: { type: "string", enum: ["left","right"], enumLabels: ["左","右"], default: "right", title: "风向" }, sandHue: { type: "string", default: "#D6A23A", title: "沙色", format: "color" }, replaceBackground: { type: "boolean", default: false, title: "替换背景", description: "是否生成沙漠背景替代原背景" } } },
    ...
    },
    {
      ...
      parameterSchema: { properties: { seed: { type: "integer", default: -1, title: "随机种子" }, profile: { type: "string", enum: ["quality_16gb","balanced_16gb"], default: "quality_16gb", title: "质量档" }, density: { type: "number", minimum: 0, maximum: 1, default: 0.5, title: "浓度", description: "烟尘密度" }, direction: { type: "string", enum: ["up","upRight","right","downRight","down"], enumLabels: ["上","右上","右","右下","下"], default: "upRight", title: "方向" }, spread: { type: "number", minimum: 0, maximum: 1, default: 0.5, title: "扩散", description: "烟雾扩散范围" }, occlusion: { type: "string", enum: ["auto","front","back"], enumLabels: ["自动","前景遮挡","后景"], default: "auto", title: "遮挡模式" } } },
      availability: { state: "ready", profile: "quality_16gb" },
    ...
    },
    {
      ...
      parameterSchema: { properties: { seed: { type: "integer", default: -1, title: "随机种子" }, profile: { type: "string", enum: ["quality_16gb","balanced_16gb"], default: "quality_16gb", title: "质量档" }, branches: { type: "number", minimum: 0, maximum: 1, default: 0.5, title: "分支数量", description: "雷电分支密度" }, color: { type: "string", default: "#C9E4FF", title: "雷电颜色", format: "color" }, glow: { type: "number", minimum: 0, maximum: 1, default: 0.6, title: "辉光" }, relight: { type: "number", minimum: 0, maximum: 1, default: 0.35, title: "环境反射", description: "雷电对场景的照亮程度" } } },
      availability: { state: "ready", profile: "quality_16gb" },
    ...
    /* ── 战斗特效 (2) ── */
    {
      ...
      icon: "combat",
      input: { source: "document", mask: "optional", points: "optional", subjectMask: "optional" },
      parameterSchema: { properties: { seed: { type: "integer", default: -1, title: "随机种子" }, profile: { type: "string", enum: ["quality_16gb","balanced_16gb"], default: "quality_16gb", title: "质量档" }, amount: { type: "number", minimum: 0, maximum: 1, default: 0.3, title: "数量" }, direction: { type: "string", enum: ["up","right","down","left","random"], enumLabels: ["上","右","下","左","随机"], default: "random", title: "方向" }, antiGravity: { type: "number", minimum: -1, maximum: 1, default: 0.35, title: "反重力", description: "负值=下落，正值=上浮" }, warmth: { type: "number", minimum: 0, maximum: 1, default: 0.8, title: "色温", description: "0=冷色 1=暖色" } } },
      availability: { state: "ready", profile: "quality_16gb" },
      ui: { order: 10, requiresConfirm: true },
      tags: ["火花", "碎石", "粒子", "战斗"],
    },
    ...
    /* ── 场照与合成 (6) ── */
    {
      ...
      parameterSchema: { properties: { seed: { type: "integer", default: -1, title: "随机种子" }, profile: { type: "string", enum: ["quality_16gb","balanced_16gb"], default: "quality_16gb", title: "质量档" }, cleanup: { type: "string", enum: ["nearby","all"], enumLabels: ["近景","全部"], default: "nearby", title: "清理范围" }, backgroundExposure: { type: "number", minimum: -2, maximum: 2, default: -0.7, title: "背景曝光", description: "负值=压暗" }, desaturate: { type: "number", minimum: 0, maximum: 1, default: 0.28, title: "降饱和" }, backgroundBlur: { type: "number", minimum: 0, maximum: 1, default: 0, title: "背景模糊", description: "轻景深效果" } } },
      availability: { state: "ready", profile: "quality_16gb" },
      ui: { order: 10, requiresConfirm: true },
      tags: ["场照", "修图", "清理", "调色"],
    },
    {
      ...
      parameterSchema: { properties: { seed: { type: "integer", default: -1, title: "随机种子" }, profile: { type: "string", enum: ["quality_16gb","balanced_16gb"], default: "quality_16gb", title: "质量档" }, backdrop: { type: "string", enum: ["white","lightGray","midGray"], enumLabels: ["纯白","浅灰","中灰"], default: "lightGray", title: "背景色" }, shadow: { type: "number", minimum: 0, maximum: 1, default: 0.35, title: "阴影强度" }, edgeDecontaminate: { type: "number", minimum: 0, maximum: 1, default: 0.6, title: "边缘去色", description: "移除抠图边缘溢色" } } },
      availability: { state: "ready", profile: "quality_16gb" },
      ui: { order: 20, requiresConfirm: true },
      tags: ["白棚", "抠图", "棚拍", "背景"],
    },
    ...
    },
    {
      ...
      icon: "studio",
      input: { source: "document", mask: "none", points: "none" },
      parameterSchema: { properties: { seed: { type: "integer", default: -1, title: "随机种子" }, profile: { type: "string", enum: ["quality_16gb","balanced_16gb"], default: "quality_16gb", title: "质量档" }, removePeople: { type: "boolean", default: true, title: "移除路人" }, removeGear: { type: "boolean", default: true, title: "移除器材", description: "移除灯架/三脚架等" }, removeClutter: { type: "number", minimum: 0, maximum: 1, default: 0.65, title: "杂物清理强度" }, protectSubject: { type: "boolean", default: true, title: "保护主体", description: "不修改主体区域" } } },
      availability: { state: "ready", profile: "quality_16gb" },
    ...
    },
    {
      ...
      icon: "studio",
      input: { source: "document", mask: "none", points: "none", subjectMask: "optional" },
      parameterSchema: { properties: { seed: { type: "integer", default: -1, title: "随机种子" }, profile: { type: "string", enum: ["quality_16gb","balanced_16gb"], default: "quality_16gb", title: "质量档" }, count: { type: "integer", minimum: 1, maximum: 5, default: 3, title: "数量" }, style: { type: "string", enum: ["fufu"], enumLabels: ["fufu风格"], default: "fufu", title: "风格" }, interaction: { type: "string", enum: ["surround","standing","sitting","floating"], enumLabels: ["环绕","站立","坐姿","漂浮"], default: "surround", title: "交互姿势" }, scale: { type: "number", minimum: 0.5, maximum: 1.5, default: 1, title: "缩放", description: "玩偶相对大小" } } },
      availability: { state: "ready", profile: "quality_16gb" },
    ...
    /* ── 人像塑形 (5) ── */
    {
      ...
      parameterSchema: { properties: { seed: { type: "integer", default: -1, title: "随机种子" }, profile: { type: "string", enum: ["quality_16gb","balanced_16gb"], default: "quality_16gb", title: "质量档" }, strength: { type: "number", minimum: 0, maximum: 1, default: 0.45, title: "强度" }, texture: { type: "number", minimum: 0, maximum: 1, default: 0.55, title: "纹理", description: "厚涂质感强度" }, sculpt: { type: "number", minimum: 0, maximum: 1, default: 0.5, title: "塑形", description: "高光阴影塑形程度" }, protectFeatures: { type: "boolean", default: true, title: "保护五官", description: "不修改眼唇等关键区域" } } },
      availability: { state: "ready", profile: "quality_16gb" },
      ui: { order: 10, requiresConfirm: true },
      tags: ["厚涂", "妆感", "皮肤", "人像"],
    },
    ...
    },
    {
      ...
      icon: "portrait",
      input: { source: "selection", mask: "none", points: "none", subjectMask: "none" },
      parameterSchema: { properties: { seed: { type: "integer", default: -1, title: "随机种子" }, profile: { type: "string", enum: ["quality_16gb","balanced_16gb"], default: "quality_16gb", title: "质量档" }, strength: { type: "number", minimum: 0, maximum: 1, default: 0.45, title: "强度" }, jaw: { type: "number", minimum: 0, maximum: 1, default: 0.4, title: "下颌", description: "下颌线条力度" }, brow: { type: "number", minimum: 0, maximum: 1, default: 0.35, title: "眉骨" }, featureDepth: { type: "number", minimum: 0, maximum: 1, default: 0.35, title: "五官深度" } } },
      availability: { state: "ready", profile: "quality_16gb" },
      ui: { order: 30, requiresConfirm: true },
      tags: ["成男", "转绘", "面部", "男性化"],
    },
    {
      ...
      parameterSchema: { properties: { seed: { type: "integer", default: -1, title: "随机种子" }, profile: { type: "string", enum: ["quality_16gb","balanced_16gb"], default: "quality_16gb", title: "质量档" }, strength: { type: "number", minimum: 0.1, maximum: 0.6, default: 0.25, title: "强度", description: "建议从低强度开始" }, preserveWaist: { type: "boolean", default: true, title: "保持腰部" }, preserveFace: { type: "boolean", default: true, title: "保持面部" } } },
      availability: { state: "ready", profile: "quality_16gb" },
      ui: { order: 40, requiresConfirm: true },
      tags: ["丰胸", "塑形", "成人"],
    },
    ...
    },
    {
      ...
      icon: "hair",
      input: { source: "selection", mask: "required", points: "none", editMask: "required" },
      parameterSchema: { properties: { seed: { type: "integer", default: -1, title: "随机种子" }, profile: { type: "string", enum: ["quality_16gb","balanced_16gb"], default: "quality_16gb", title: "质量档" }, wind: { type: "string", enum: ["left","right","up"], enumLabels: ["左","右","上"], default: "right", title: "风向" }, strength: { type: "number", minimum: 0, maximum: 1, default: 0.5, title: "强度" }, turbulence: { type: "number", minimum: 0, maximum: 1, default: 0.25, title: "湍流", description: "不规则飘动程度" }, preserveLength: { type: "boolean", default: true, title: "保留长度" } } },
      availability: { state: "ready", profile: "quality_16gb" },
      ui: { order: 40, requiresConfirm: true },
      tags: ["飘发", "风", "氛围", "头发"],
    },
    ...
    },
    {
      ...
      icon: "lighting",
      input: { source: "document", mask: "none", points: "none", subjectMask: "optional" },
      parameterSchema: { properties: { seed: { type: "integer", default: -1, title: "随机种子" }, profile: { type: "string", enum: ["quality_16gb","balanced_16gb"], default: "quality_16gb", title: "质量档" }, direction: { type: "string", enum: ["backCenter","backLeft","backRight","topBack"], enumLabels: ["后中","左后","右后","顶后"], default: "backCenter", title: "光源方向" }, power: { type: "number", minimum: 0, maximum: 1, default: 0.55, title: "强度" }, haze: { type: "number", minimum: 0, maximum: 1, default: 0.2, title: "空气透视", description: "大气雾感" }, temperature: { type: "integer", minimum: 2500, maximum: 10000, default: 5500, title: "色温 (K)" } } },
      availability: { state: "ready", profile: "quality_16gb" },
      ui: { order: 60, requiresConfirm: true },
      tags: ["逆光", "背光", "空气透视", "重照"],
    },
