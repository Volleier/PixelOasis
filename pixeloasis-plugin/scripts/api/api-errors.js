...
window.PO.ApiErrors = (function () {
  ...
  var ERROR_MESSAGES_ZH = {
    ...
    INPUT_SOURCE_INVALID:      "输入源范围类型无效，请重新选择输入区域",
    SUBJECT_MASK_REQUIRED:     "此功能需要主体遮罩，请先提供主体选区",
    POINTS_REQUIRED:           "此功能需要指定效果的起止点，请填写坐标",
    ASSET_KIND_INVALID:        "上传素材类型不匹配，请重新捕获",
    CAPABILITY_NOT_READY:      "此功能尚未就绪，请检查模型和环境配置",
    ...
    ONLINE_AUTH_MISSING:       "在线网关未配置 API Key",
    ONLINE_AUTH_INVALID:       "在线生图 API Key 无效",
    ONLINE_QUOTA_EXCEEDED:     "在线生图额度不足或请求过于频繁",
    ONLINE_PROVIDER_ERROR:     "在线生图服务异常",
    ONLINE_RESULT_MISSING:     "在线生图未返回图片",
    ONLINE_GENERATION_FAILED:  "在线生图失败",
  ...
  var ERROR_ACTIONS = {
    ...
    INPUT_SOURCE_INVALID:      "recapture",
    SUBJECT_MASK_REQUIRED:     "recapture-selection",
    POINTS_REQUIRED:           "check-params",
    ASSET_KIND_INVALID:        "recapture",
    CAPABILITY_NOT_READY:      "open-environment",
    ...
    ONLINE_AUTH_MISSING:       "open-environment",
    ONLINE_AUTH_INVALID:       "open-environment",
    ONLINE_QUOTA_EXCEEDED:     "open-environment",
    ONLINE_PROVIDER_ERROR:     "retry",
    ONLINE_RESULT_MISSING:     "retry",
    ONLINE_GENERATION_FAILED:  "retry",
  ...
  var RETRYABLE_CODES = {
    ...
    ONLINE_PROVIDER_ERROR:     true,
    ONLINE_RESULT_MISSING:     true,
    ONLINE_GENERATION_FAILED:  true,
    NETWORK_ERROR:             true,
    TIMEOUT:                   true,
