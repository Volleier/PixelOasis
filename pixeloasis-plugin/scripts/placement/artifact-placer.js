...
window.PO.ArtifactPlacer = (function () {
  ...
  /* ── Artifact role → default layer name mapping ── */
  var ROLE_LAYER_NAMES = {
    smoke:             "黑色烟雾",
    dust:              "烟尘颗粒",
    compositePreview:  "黑色烟尘预览",
    desertBackground:  "沙漠背景",
    farDust:           "远景沙尘",
    nearDebris:        "近景碎石",
    lightning:         "雷电",
    glow:              "辉光",
    waterHighlights:   "水面波光",
    sparkleGlow:       "闪烁辉光",
    sparks:            "火花",
    debris:            "碎石",
    backTrails:        "后景弹道",
    ...
    rimLight:          "轮廓光",
    ambientHaze:       "环境雾",
    subjectUnderlight: "主体底光",
    environmentSpill:  "环境溢光",
    dimensionalRender: "立体化渲染",
    lightShade:        "明暗增强",
    cleanupComposite:  "清场合成",
    gearRemoval:       "器材移除",
    supportRemoval:    "移除结果",
    lightingEnhancement:"光影增强",
    haze:              "空气透视",
    backlight:         "逆光",
    environmentReflection:"环境反射",
  };
